...
from allenai_common.checks import ConfigurationError
from allenai_common.lazy import Lazy
from allenai_common.params import Params
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from allenai_common.registrable import Registrable  # import here to avoid circular imports
...
def construct_arg(
    ...
    **extras,
    ...
    # which it creates by instantiating each value from_params and returning the resulting structure.
        ...
        # type: ignore
        return Lazy(value_cls, params=deepcopy(popped_params), contructor_extras=subextras)
...
class FromParams:
    ...
    def from_params(
        ...
        constructor_to_inspect: Union[Callable[...,
                                               T], Callable[[T], None]] = None,
        **extras,
    ) -> T:
        """
        ...
        if registered_subclasses is not None and not constructor_to_call:
            ...
            if constructor_to_inspect == object.__init__:
                ...
                constructor_to_inspect = cast(
                    Callable[..., T], constructor_to_inspect)
                kwargs = create_kwargs(
                    constructor_to_inspect, cls, params, **extras)
